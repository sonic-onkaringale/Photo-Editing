...
object ColorFilterGenerator {
    ...
    fun adjustContrast(cm: ColorMatrix, value: Int) {
        var value = value
        ...
        if (value < 0) {
            ...
            x = if (x == 0f) {
                ...
                DELTA_INDEX[value shl 0].toFloat() * (1 - x) + DELTA_INDEX[(value shl 0) + 1]
                    .toFloat() * x // use linear interpolation for more granularity.
            }
            x = x * 127 + 127
        }
        val mat = floatArrayOf(
